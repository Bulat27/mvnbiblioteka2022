...
public interface BibliotekaInterfejs {
	 ...
	 * 
	 * Dodaj knjigu u biblioteku samo ako knjiga vec ne postoji u biblioteci i ako
	 * nije null. U principu, nema duplikata u biblioteci.
	 * 
	 * @param knjiga knjiga koju treba dodati u biblioteku
	 * @throws java.lang.NullPointerException     ako je uneta knjiga null
	 * @throws java.lang.IllegalArgumentException ako uneta knjiga vec postoji u
	 *                                            biblioteci
	 * 
	...
	/**
	 * Pronalazi i vraca listu sa svim knjigama iz biblioteke koji zadovoljavaju
	 * uslove pretrage.
	 * 
	 * Nije potrebno uneti sve parametre pretrage, pretraga se vrsi prema
	 * parametrima koji su uneti odnosno nisu null i veci su od nule (ISBN).
	 * Pretraga se vrsi prema delu naslov, odnosno delu naziva izdavaca, nije
	 * neophodno uneti tacan naziv. Ova pretraga nije osetljiva na velika i mala
	 * slova. Pretraga po ISBN broju je tacna.
	 * 
